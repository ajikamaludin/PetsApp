...
public class PetProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        //nitialize a PetDbHelper object to gain access to the pets database.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (weight != null && weight <= 0 ) {
            throw new IllegalArgumentException("Pet weight must be more than 0 kg");
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                ...
                rowDelete = database.delete(PetEntry.TABLE_NAME, selection, selectionArgs);
                if(rowDelete != 0){
                    getContext().getContentResolver().notifyChange(uri, null);
                }
                return rowDelete;
